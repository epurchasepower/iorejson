...
Rejson.prototype.set = function(key, path, value) {
  ...
  return cmd.call(this.client, this.keyPrefix + key, path, _value).then(function(result) {
    if (result === 'OK') {
      return true;
    }
...
Rejson.prototype.get = function(key, path) {
  ...
  return cmd.call(this.client, this.keyPrefix + key, path).then(function(value) {
...
Rejson.prototype.del = function(key, path) {
  ...
  return cmd.call(this.client, this.keyPrefix + key, path).then(function(result) {
    return result === 1;
  });
};
...
Rejson.prototype.objkeys = function(key, path) {
  ...
  return cmd.call(this.client, this.keyPrefix + key, path);
};
...
Rejson.prototype.numincrby = function(key, path, number) {
  ...
  return cmd.call(this.client, this.keyPrefix + key, path, number).then(function(result) {
...
Rejson.prototype.strappend = function(key, path, string) {
  ...
  return cmd.call(this.client, this.keyPrefix + key, path, JSON.stringify(string));
};
...
Rejson.prototype.arrindex = function(key, path, scalar) {
  ...
  return cmd.call(this.client, this.keyPrefix + key, path, JSON.stringify(scalar));
};
...
Rejson.prototype.arrinsert = function() {
  ...
  fixed[0] = this.keyPrefix + fixed[0]
...
Rejson.prototype.arrpop = function(key, path, index) {
  ...
  return cmd.call(this.client, this.keyPrefix + key, path, index).then(function(result) {
...
Rejson.prototype.arrtrim = function(key, path, start, end) {
  ...
  return cmd.call(this.client, this.keyPrefix + key, path, start, end);
};
